...
public class OdontologoEntradaDto {
    ...
    @Size (min = 5, max = 10, message = "El campo debe tener un minimo de 5 caracteres y un maximo de 10")
    private String matricula;
    @NotNull (message = "el nombre no puede ser nulo")
    @NotBlank(message = "el campo no puede estar vacio")
    @Size (min = 2, message = "El campo debe tener un minimo de 2 caracteres")
